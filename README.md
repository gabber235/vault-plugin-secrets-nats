...
spec:
  ...
  image: ghcr.io/gabber235/vault-plugin-secrets-nats/vault-with-nats-secrets:1.2.0
  config:
    disable_mlock: true
  ...
  externalConfig:
    ...
    - plugin_name: vault-plugin-secrets-nats
      ...
      sha256: 6438f6f35d4fe7c6d66083532502aa4566d0823dd24cb4bb5625dd5cf3f21039
      type: secret
    secrets:
    - path: nats-secrets
      type: plugin
